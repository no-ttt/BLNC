        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li><a href="/about" className="hover:text-pink-500 transition-colors">關於我們</a></li>
              <li><a href="/health-column" className="hover:text-pink-500 transition-colors">健康專欄</a></li>
              <li><a href="/reviews" className="hover:text-pink-500 transition-colors">消費者好評</a></li>
              <li><a href="/nutrition-center" className="hover:text-pink-500 transition-colors">營養中心</a></li>
            </ul>
          </div>
