    ...
    <div className="min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="text-center mt-16 p-12 bg-gradient-to-r from-blue-50 via-purple-25 to-pink-50 rounded-3xl"
        >
          ...
          <button className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-400 via-purple-400 to-yellow-400 text-white font-semibold rounded-full hover:shadow-lg transform hover:scale-105 transition-all duration-200">
            開始我的健康之旅
